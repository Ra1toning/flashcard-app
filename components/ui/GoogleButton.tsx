...
export default function GoogleButton({ label = "Google-ээр үргэлжлүүлэх" }: { label?: string }) {
  ...
  return (
    <button
      ...
      className="btn-secondary w-full justify-center gap-3 px-5 py-3 disabled:opacity-50"
    >
      <GoogleIcon />
      {loading ? "Шилжиж байна..." : label}
    </button>
  );
}
